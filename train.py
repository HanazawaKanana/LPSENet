...
from lion_pytorch import Lion##Lion优化器
...
def main(args):
    ...
    if hasattr(model.module, 'optimizer'):
        ...
        if cfg.train_cfg.optimizer == 'SGD':
            ...
            optimizer = torch.optim.AdamW(model.parameters(), lr=cfg.train_cfg.lr, weight_decay=5e-4)
        elif cfg.train_cfg.optimizer == 'Lion':##定义一下Lion优化器
            optimizer = Lion(model.parameters(), lr=cfg.train_cfg.lr, betas=(0.99,0.999), weight_decay=5e-4)
